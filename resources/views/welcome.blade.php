                    ...
                    <div class="col h-100 p-lg-0">
                        <div class="d-flex flex-column gap-3 justify-content-center h-100">
							...
							<p class="text-gray fs-5 mt-0">
								@lang("Highness Podcast opens new windows onto the market like you've never seen before.")
							</p>
                ...
                <div class="d-flex flex-lg-row flex-column-reverse gap-3">
                    ...
                    <div class="col col-lg-6">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div>
                                <a href="index.html" class="btn button font-1 ls-2">ALL TESTIMONIALS
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="r-container position-relative" style="z-index: 2;">
                <div class="d-flex flex-column text-center gap-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="index.html" class="btn button font-1 ls-2">VIEW ALL PODCASTS
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-lg-row flex-column-reverse gap-3">
                            ...
                            <div class="col mb-3">
                                <div class="card border-0 bg-secondary-color p-3 shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="index.html#" class="btn link font-1 fw-bold">LEARN MORE <i
                    ...
                    <div class="col col-lg-5 ps-lg-5 mb-3">
                        <div class="d-flex flex-column h-100 justify-content-center gap-3">
                            ...
                            <div>
                                <a href="index.html" class="btn button font-1 ls-2">ALL BLOGS
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col col-lg-3 mb-3">
                                    <div class="d-flex flex-column gap-3 px-4 px-lg-5">
                                        ...
                                        <ul class="list">
                                            ...
                                            <li class="d-flex flex-row align-items-center gap-3">
                                                <i class="fa-solid fa-chevron-right accent-color"></i>
                                                <a href="index.html" class="link-white">About Us</a>
                                            </li>
                                            <li class="d-flex flex-row align-items-center gap-3">
                                                <i class="fa-solid fa-chevron-right accent-color"></i>
                                                <a href="index.html" class="link-white">Podcasts</a>
                                            </li>
                                            <li class="d-flex flex-row align-items-center gap-3">
                                                <i class="fa-solid fa-chevron-right accent-color"></i>
                                                <a href="index.html" class="link-white">Gallery</a>
                                            </li>
                                            <li class="d-flex flex-row align-items-center gap-3">
                                                <i class="fa-solid fa-chevron-right accent-color"></i>
                                                <a href="index.html" class="link-white">Blog</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
